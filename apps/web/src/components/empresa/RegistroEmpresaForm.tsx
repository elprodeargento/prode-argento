      ...
      <div className="bg-[#002B72] p-8 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <div className="mb-4 flex justify-center">
            <img src="/EL PRODE ARGENTO-04.png" alt="El Prode Argento" className="h-28 w-auto object-cover" />
          </div>
          <div className="font-bebas text-xl text-[#F5C518] tracking-widest">PARA COMERCIOS</div>
          <div className="text-white/80 text-sm mt-1 font-medium">Creá tu propio prode en minutos</div>
        </div>
      </div>
